...
See spark_4.py for original code
...
v 4.0a last revised 5 Dec 2015
...
n_partitions = 16 # number of partitions to be used
max_edit_distance = 3
...
if __name__ == "__main__":
    ...
    start_time = time.time()
    correct_document("s3n://spark-n-spell/OCRsample.txt", d, lwl, False)
    run_time = time.time() - start_time
    print '-----'
    print '%.2f seconds to run' % run_time
    print '-----'
